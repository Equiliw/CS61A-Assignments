...
def distance(city_a, city_b):
    ...
    return f(get_lat(city_a) - get_lat(city_b), get_lon(city_a) - get_lon(city_b))
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    pos = make_city('P', lat, lon)
    return get_name(city_b) if distance(pos, city_b) <= distance(pos, city_a) else get_name(city_a)
