...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    pre_score = player_score + take_turn(num_rolls, player_score, opponent_score, dice)
    return sus_points(pre_score)
    # END PROBLEM 4
...
def make_averaged(original_function, times_called=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    assert times_called > 0, 'you cant call function 0 times'
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    "*** YOUR CODE HERE ***"
    num, val = 0,0
    res_func = make_averaged(roll_dice, times_called)
    for k in range(1, 11):
        res = res_func(k, dice)
        if (res > val):
            num, val = k, res
